...
import cardioid_AC_utils as cAC


def main():
    parser = argparse.ArgumentParser(description='From point of maximum displacement, '
                                                 'calculate AC along half of the dataset in CW order, '
                                                 'the other half of the dataset in CCW order. Average the two')
