...
def main():
    ...
    num_features_sign_change, num_features_1st_deriv, num_features_2nd_deriv = [], [], []
    processed_results_df = pd.DataFrame(columns=['filename','num_features_sign_change', "num_features_1st_deriv", 'num_features_2nd_deriv'])
    if len(csvs_and_paths)==0:
        ...
        for csv_file in csvs_and_paths:
            ...
            if 'num_features_sign_change' in results_df.columns and 'num_features_2nd_deriv' in results_df.columns:
                ...
                num_features_1st_deriv.append(results_df['num_features_1st_deriv'][0])
        ...
        processed_results_df['num_features_1st_deriv'] = num_features_1st_deriv
